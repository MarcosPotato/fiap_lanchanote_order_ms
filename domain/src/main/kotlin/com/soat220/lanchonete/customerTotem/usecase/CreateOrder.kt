...
import com.soat220.lanchonete.providers.PaymentProvider.implementations.PaymentMS
...
class CreateOrder(
    ...
    private val paymentProvider: PaymentMS,
    ...
    private fun verifyPayment(orderItems: MutableList<OrderItem>) {
        ...
        paymentProvider.createPayment(order, paymentStatus, totalAmount).orThrow()
